...
const data = {
    ...
    "about_full":"I'm a passionate Java Backend Developer with 2.5 years of experience building robust and scalable web applications. Outside of coding, I’m a chess enthusiast, an anime fan, and love dancing. I believe in writing clean, maintainable code and continuously improving my skills to provide high-quality solutions while embracing a balance of work and creativity.",
    ...
    "workExperience": [
      ...
      },
      {
        ...
        "description_large":"Developed a Route Management app for airport vehicles using Spring Boot and React Native, incorporating a robust JWT-based authentication system for secure access. Designed and implemented scalable backend models for vehicles and routes, enabling efficient route assignments and vehicle tracking through RESTful APIs. Led a team of four developers, ensuring smooth collaboration and technical excellence. Worked closely with the frontend team to ensure seamless integration, enhancing overall system functionality and user experience.",
        "description_short":"Developed a Route Management app for airport vehicles using Spring Boot and React Native with JWT-based authentication. Designed scalable backend models for vehicle tracking and route assignments through RESTful APIs. Led a team of four developers, ensuring smooth collaboration and integration with the frontend for enhanced system functionality.",
        "description_xs":"Developed a Route Management app for airport vehicles using Spring Boot and React Native with JWT-based authentication. Designed scalable backend models for vehicle tracking and route assignments through RESTful APIs."
      }
    ],
    "awards": [
      {
